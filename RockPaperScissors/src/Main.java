...
class Game {
	...
	public static void panel_game() {
		...
		for (int i = 0; i <= 2; i++) {
            icon_path[i] = "C:\\Users\\User\\RockPaperScissors\\bin\\" + i + ".png";
	...
	public static void compute_winner(int choice_human) {
		...
		JLabel image_human = new JLabel(
				new ImageIcon("C:\\Users\\User\\RockPaperScissors\\bin\\" + (choice_human - 1) + ".png"));
		image_human.setBounds(10, 100, 200, 250);
		score_panel.add(image_human);

		JLabel image_computer = new JLabel(
				new ImageIcon("C:\\Users\\User\\RockPaperScissors\\bin\\" + (choice_computer - 1) + "c.png"));
